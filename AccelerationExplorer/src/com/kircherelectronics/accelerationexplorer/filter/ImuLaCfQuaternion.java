 ...
 * filter. Quaternion is added because the filter applies the complementary
 * filter to the quaternions from the gyroscope and acceleration/magnetic
 ...
 * 
 * ImuLaCfQuaternion attempts to fuse magnetometer, gravity and gyroscope
